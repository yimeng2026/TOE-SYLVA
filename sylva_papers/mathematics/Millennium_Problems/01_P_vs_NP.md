...
- 千禧年问题2（Hodge猜想）— GCT纲领：几何复杂性理论与代数几何的交汇
- 千禧年问题3（黎曼假设）— 素性测试与计算数论的复杂性
- 希尔伯特第10问题（丢番图方程）— 可判定性与计算复杂性
- 希尔伯特第14问题（代数不变量）— GCT中不变量环的有限生成性

### 关联的 SYLVA Lean 形式化模块
- `Computability/CookLevin.lean` — SYLVA 形式化代码库核心模块
- `Computability/PolynomialTime.lean` — SYLVA 形式化代码库核心模块
- `NPClass/Basic.lean` — SYLVA 形式化代码库核心模块
- `Complexity/CookLevin_theorem.lean` — SYLVA 形式化代码库核心模块
