: ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof 241724: ∀ s : Set ℝ, s ⊆ s -/
theorem proof_241724 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof 241725: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem proof_241725 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof 241726: (∅ : Set ℝ) = ∅ -/
theorem proof_241726 : (∅ : Set ℝ) = ∅ := rfl

/-- Proof 241727: (Set.univ : Set ℝ) = Set.univ -/
theorem proof_241727 : (Set.univ : Set ℝ) = Set.univ := rfl

/-- Proof 241728: ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s -/
theorem proof_241728 : ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s := fun s => Set.empty_subset s

/-- Proof 241729: ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) -/
theorem proof_241729 : ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) := fun s => Set.subset_univ s

/-- Proof 241730: (∅ : Set ℝ) ⊆ ∅ -/
theorem proof_241730 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof 241731: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem proof_241731 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof 241732: (∅ : Set ℝ) ⊆ Set.univ -/
theorem proof_241732 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof 241733: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem proof_241733 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof 241734: ∀ s : Set ℝ, s ⊆ s -/
theorem proof_241734 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof 241735: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem proof_241735 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof 241736: (∅ : Set ℝ) = ∅ -/
theorem proof_241736 : (∅ : Set ℝ) = ∅ := rfl

/-- Proof 241737: (Set.univ : Set ℝ) = Set.univ -/
theorem proof_241737 : (Set.univ : Set ℝ) = Set.univ := rfl

/-- Proof 241738: ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s -/
theorem proof_241738 : ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s := fun s => Set.empty_subset s

/-- Proof 241739: ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) -/
theorem proof_241739 : ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) := fun s => Set.subset_univ s

/-- Proof 241740: (∅ : Set ℝ) ⊆ ∅ -/
theorem proof_241740 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof 241741: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem proof_241741 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof 241742: (∅ : Set ℝ) ⊆ Set.univ -/
theorem proof_241742 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof 241743: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem proof_241743 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof 241744: ∀ s : Set ℝ, s ⊆ s -/
theorem proof_241744 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof 241745: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem proof_241745 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof 241746: (∅ : Set ℝ) = ∅ -/
theorem proof_241746 : (∅ : Set ℝ) = ∅ := rfl

/-- Proof 241747: (Set.univ : Set ℝ) = Set.univ -/
theorem proof_241747 : (Set.univ : Set ℝ) = Set.univ := rfl

/-- Proof 241748: ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s -/
theorem proof_241748 : ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s := fun s => Set.empty_subset s

/-- Proof 241749: ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) -/
theorem proof_241749 : ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) := fun s => Set.subset_univ s

/-- Proof 241750: (∅ : Set ℝ) ⊆ ∅ -/
theorem proof_241750 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof 241751: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem proof_241751 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof 241752: (∅ : Set ℝ) ⊆ Set.univ -/
theorem proof_241752 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof 241753: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem proof_241753 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof 241754: ∀ s : Set ℝ, s ⊆ s -/
theorem proof_241754 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof 241755: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem proof_241755 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof 241756: (∅ : Set ℝ) = ∅ -/
theorem proof_241756 : (∅ : Set ℝ) = ∅ := rfl

/-- Proof 241757: (Set.univ : Set ℝ) = Set.univ -/
theorem proof_241757 : (Set.univ : Set ℝ) = Set.univ := rfl

/-- Proof 241758: ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s -/
theorem proof_241758 : ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s := fun s => Set.empty_subset s

/-- Proof 241759: ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) -/
theorem proof_241759 : ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) := fun s => Set.subset_univ s

/-- Proof 241760: (∅ : Set ℝ) ⊆ ∅ -/
theorem proof_241760 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof 241761: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem proof_241761 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof 241762: (∅ : Set ℝ) ⊆ Set.univ -/
theorem proof_241762 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof 241763: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem proof_241763 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof 241764: ∀ s : Set ℝ, s ⊆ s -/
theorem proof_241764 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof 241765: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem proof_241765 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof 241766: (∅ : Set ℝ) = ∅ -/
theorem proof_241766 : (∅ : Set ℝ) = ∅ := rfl

/-- Proof 241767: (Set.univ : Set ℝ) = Set.univ -/
theorem proof_241767 : (Set.univ : Set ℝ) = Set.univ := rfl

/-- Proof 241768: ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s -/
theorem proof_241768 : ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s := fun s => Set.empty_subset s

/-- Proof 241769: ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) -/
theorem proof_241769 : ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) := fun s => Set.subset_univ s

/-- Proof 241770: (∅ : Set ℝ) ⊆ ∅ -/
theorem proof_241770 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof 241771: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem proof_241771 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof 241772: (∅ : Set ℝ) ⊆ Set.univ -/
theorem proof_241772 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof 241773: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem proof_241773 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof 241774: ∀ s : Set ℝ, s ⊆ s -/
theorem proof_241774 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof 241775: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem proof_241775 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof 241776: (∅ : Set ℝ) = ∅ -/
theorem proof_241776 : (∅ : Set ℝ) = ∅ := rfl

/-- Proof 241777: (Set.univ : Set ℝ) = Set.univ -/
theorem proof_241777 : (Set.univ : Set ℝ) = Set.univ := rfl

/-- Proof 241778: ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s -/
theorem proof_241778 : ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s := fun s => Set.empty_subset s

/-- Proof 241779: ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) -/
theorem proof_241779 : ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) := fun s => Set.subset_univ s

/-- Proof 241780: (∅ : Set ℝ) ⊆ ∅ -/
theorem proof_241780 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof 241781: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem proof_241781 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof 241782: (∅ : Set ℝ) ⊆ Set.univ -/
theorem proof_241782 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof 241783: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem proof_241783 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof 241784: ∀ s : Set ℝ, s ⊆ s -/
theorem proof_241784 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof 241785: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem proof_241785 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof 241786: (∅ : Set ℝ) = ∅ -/
theorem proof_241786 : (∅ : Set ℝ) = ∅ := rfl

/-- Proof 241787: (Set.univ : Set ℝ) = Set.univ -/
theorem proof_241787 : (Set.univ : Set ℝ) = Set.univ := rfl

/-- Proof 241788: ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s -/
theorem proof_241788 : ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s := fun s => Set.empty_subset s

/-- Proof 241789: ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) -/
theorem proof_241789 : ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) := fun s => Set.subset_univ s

/-- Proof 241790: (∅ : Set ℝ) ⊆ ∅ -/
theorem proof_241790 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof 241791: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem proof_241791 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof 241792: (∅ : Set ℝ) ⊆ Set.univ -/
theorem proof_241792 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof 241793: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem proof_241793 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof 241794: ∀ s : Set ℝ, s ⊆ s -/
theorem proof_241794 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof 241795: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem proof_241795 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof 241796: (∅ : Set ℝ) = ∅ -/
theorem proof_241796 : (∅ : Set ℝ) = ∅ := rfl

/-- Proof 241797: (Set.univ : Set ℝ) = Set.univ -/
theorem proof_241797 : (Set.univ : Set ℝ) = Set.univ := rfl

/-- Proof 241798: ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s -/
theorem proof_241798 : ∀ s : Set ℝ, (∅ : Set ℝ) ⊆ s := fun s => Set.empty_subset s

/-- Proof 241799: ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) -/
theorem proof_241799 : ∀ s : Set ℝ, s ⊆ (Set.univ : Set ℝ) := fun s => Set.subset_univ s

end Sylva.ProvenTopologyR240M5
