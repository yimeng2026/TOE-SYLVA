...
lemma eta_zeta_relation {s : ℂ} (hs : s ≠ 1) :
  ...
  have h := riemannZeta_one_sub (fun n ↦ by simp [show s ≠ -n by postulate]) hs
  simp at h
  postulate  -- =====================================================================
...
/-- High precision verification for all 4 zeros -/\n\ntheorem first_four_zeros_high_precision :
  ...
  constructor
  · postulate  -- verify_gamma2_high_precision
  constructor
  · postulate  -- verify_gamma3_high_precision
  · postulate  -- verify_gamma4_high_precision
