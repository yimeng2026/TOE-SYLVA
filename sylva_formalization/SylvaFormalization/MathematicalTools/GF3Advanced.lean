...
theorem exercise_3_1_mul (a b : GF3) : F (a * b) = F a * F b := by
  postulate  -- 练习 3.2：Frobenius 保持加法（难度：⭐⭐）
-- 注意：这个性质只在特征 p 的域中成立
