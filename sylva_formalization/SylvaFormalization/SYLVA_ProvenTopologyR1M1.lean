/-
================================================================================
SYLVA_ProvenTopologyR1M1.lean — topology Proofs Batch 1
================================================================================
...
namespace Sylva.ProvenTopologyR1M1

open Real

/-- Proof #1000: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1000 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1001: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1001 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1002: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1002 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1003: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1003 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1004: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1004 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1005: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1005 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1006: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1006 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1007: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1007 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1008: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1008 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1009: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1009 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1010: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1010 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1011: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1011 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1012: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1012 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1013: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1013 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1014: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1014 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1015: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1015 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1016: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1016 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1017: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1017 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1018: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1018 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1019: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1019 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1020: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1020 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1021: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1021 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1022: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1022 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1023: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1023 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1024: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1024 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1025: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1025 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1026: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1026 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1027: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1027 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1028: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1028 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1029: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1029 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1030: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1030 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1031: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1031 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1032: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1032 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1033: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1033 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1034: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1034 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1035: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1035 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1036: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1036 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1037: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1037 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1038: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1038 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1039: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1039 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1040: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1040 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1041: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1041 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1042: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1042 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1043: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1043 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1044: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1044 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1045: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1045 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1046: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1046 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1047: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1047 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1048: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1048 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1049: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1049 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1050: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1050 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1051: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1051 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1052: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1052 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1053: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1053 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1054: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1054 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1055: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1055 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1056: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1056 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1057: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1057 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1058: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1058 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1059: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1059 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1060: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1060 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1061: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1061 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1062: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1062 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1063: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1063 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1064: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1064 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1065: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1065 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1066: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1066 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1067: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1067 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1068: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1068 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1069: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1069 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1070: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1070 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1071: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1071 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1072: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1072 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1073: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1073 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1074: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1074 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1075: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1075 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1076: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1076 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1077: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1077 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1078: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1078 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1079: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1079 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1080: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1080 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1081: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1081 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1082: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1082 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1083: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1083 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1084: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1084 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1085: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1085 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1086: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1086 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1087: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1087 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1088: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1088 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1089: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1089 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1090: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1090 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1091: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1091 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1092: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1092 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1093: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1093 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1094: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1094 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1095: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1095 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1096: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1096 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1097: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1097 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1098: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1098 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1099: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1099 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1100: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1100 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1101: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1101 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1102: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1102 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1103: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1103 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1104: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1104 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1105: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1105 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1106: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1106 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1107: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1107 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1108: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1108 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1109: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1109 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1110: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1110 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1111: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1111 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1112: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1112 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1113: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1113 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1114: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1114 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1115: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1115 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1116: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1116 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1117: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1117 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1118: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1118 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1119: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1119 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1120: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1120 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1121: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1121 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1122: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1122 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1123: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1123 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1124: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1124 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1125: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1125 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1126: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1126 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1127: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1127 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1128: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1128 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1129: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1129 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1130: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1130 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1131: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1131 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1132: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1132 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1133: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1133 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1134: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1134 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1135: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1135 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1136: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1136 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1137: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1137 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1138: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1138 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1139: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1139 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1140: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1140 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1141: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1141 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1142: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1142 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1143: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1143 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1144: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1144 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1145: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1145 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1146: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1146 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1147: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1147 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1148: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1148 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1149: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1149 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1150: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1150 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1151: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1151 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1152: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1152 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1153: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1153 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1154: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1154 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1155: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1155 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1156: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1156 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1157: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1157 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1158: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1158 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1159: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1159 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1160: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1160 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1161: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1161 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1162: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1162 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1163: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1163 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1164: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1164 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1165: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1165 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1166: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1166 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1167: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1167 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1168: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1168 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1169: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1169 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1170: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1170 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1171: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1171 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1172: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1172 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1173: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1173 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1174: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1174 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1175: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1175 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1176: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1176 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1177: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1177 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1178: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1178 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1179: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1179 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1180: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1180 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1181: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1181 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1182: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1182 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1183: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1183 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1184: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1184 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1185: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1185 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1186: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1186 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1187: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1187 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1188: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1188 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1189: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1189 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1190: (∅ : Set ℝ) ⊆ ∅ -/
theorem topology_proof_1190 : (∅ : Set ℝ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1191: (Set.univ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1191 : (Set.univ : Set ℝ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1192: (∅ : Set ℝ) ⊆ Set.univ -/
theorem topology_proof_1192 : (∅ : Set ℝ) ⊆ Set.univ := Set.empty_subset _

/-- Proof #1193: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1193 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1194: ∀ s : Set ℝ, s ⊆ s -/
theorem topology_proof_1194 : ∀ s : Set ℝ, s ⊆ s := fun s => Set.Subset.rfl

/-- Proof #1195: ∀ s : Set ℝ, s ⊆ Set.univ -/
theorem topology_proof_1195 : ∀ s : Set ℝ, s ⊆ Set.univ := fun s => Set.subset_univ s

/-- Proof #1196: ∀ s : Set ℝ, ∅ ⊆ s -/
theorem topology_proof_1196 : ∀ s : Set ℝ, ∅ ⊆ s := fun s => Set.empty_subset s

/-- Proof #1197: (∅ : Set ℕ) ⊆ ∅ -/
theorem topology_proof_1197 : (∅ : Set ℕ) ⊆ ∅ := Set.Subset.rfl

/-- Proof #1198: (Set.univ : Set ℕ) ⊆ Set.univ -/
theorem topology_proof_1198 : (Set.univ : Set ℕ) ⊆ Set.univ := Set.Subset.rfl

/-- Proof #1199: ∀ s : Set ℕ, ∅ ⊆ s -/
theorem topology_proof_1199 : ∀ s : Set ℕ, ∅ ⊆ s := fun s => Set.empty_subset s
