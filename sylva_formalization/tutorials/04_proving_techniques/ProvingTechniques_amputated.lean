...
theorem exercise_2_1 (a b : ℝ) (h : a^2 + b^2 = 0) : a = 0 ∧ b = 0 := by
  ...
  have hsum : a ^ 2 + b ^ 2 ≥ 0 := add_nonneg ha hb
  have ha0 : a ^ 2 = 0 := by
    nlinarith
  have hb0 : b ^ 2 = 0 := by
    nlinarith
...
theorem exercise_2_2 (a b c d : ℝ) : (a^2 + b^2) * (c^2 + d^2) ≥ (a*c + b*d)^2 := by
  have h : (a^2 + b^2) * (c^2 + d^2) - (a*c + b*d)^2 = (a*d - b*c)^2 := by
    ring
  have hnonneg : (a*d - b*c)^2 ≥ 0 := pow_two_nonneg _
  nlinarith
-- ============================================================================
-- SECTION 3: 反证法
-- ============================================================================
...
theorem challenge_AM_GM (a b : ℝ) (ha : 0 ≤ a) (hb : 0 ≤ b) :
  ...
  have hnonneg : 0 ≤ a + b := add_nonneg ha hb
  have hprod_nonneg : 0 ≤ a * b := mul_nonneg ha hb
  have h1 : ((a + b)/2) ^ 2 ≥ (Real.sqrt (a * b)) ^ 2 := by
    calc
