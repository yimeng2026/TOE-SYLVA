...
/-
================================================================================
CONCEPT: Frobenius 自同态 x ↦ x3
================================================================================

🎯 核心概念:
对于有限域 GF(p),Frobenius 映射 F(x) = xp 是一个域自同态。
对于 GF(3),F(x) = x3。
...
⚠️ 注意事项:
在 GF(3) 中,对于任意 a ∈ GF(3),都有 a3 = a(费马小定理)
================================================================================
-/
...
GF(9) 可以表示为 GF(3)[X]/(X2+1),即 GF(3) 上多项式环模 X2+1。
