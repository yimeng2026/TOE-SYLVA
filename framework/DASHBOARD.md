...
|------|--------|--------|-----------------|-------|-----------|---------------|
| 人工策划 (handcrafted) | 22257 | 546356 | 553 | 78 | 545235 | **99.79%** |
| 批量 (SYLVA_Proven*) | 119859 | 26239728 | 0 | 0 | 26239728 | **100.00%** |
| 其它 (test/template) | 61 | 734 | 14 | 112 | 585 | **79.70%** |

> ⚠️ 批量模块定理虽零 axiom 零 sorry，但全部为平凡代数恒等式（`0+0=0` 级别），**不得与人工策划模块合并**计算「总证明率」。详见 `proof_rate_report.md` 口径说明。

<!-- END: PROOF_RATE_SECTION -->
...
* v7.73: docs 115-119 (Network Science/Quantum Computing/Materials/Nuclear/Finance CNF)